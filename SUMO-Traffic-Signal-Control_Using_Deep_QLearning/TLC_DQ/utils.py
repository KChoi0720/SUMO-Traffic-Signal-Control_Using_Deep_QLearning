...
def import_test_configuration(config_file):
    ...
    if 'simulation' not in content:
            print("Simulation section not found in configuration file")
            return None
    ...
    if 'agent' not in content:
        print("Agent section not found in configuration file")
        return None
    ...
    if 'dir' not in content:
            print("Dir section not found in configuration file")
            return None
